...
use tramway_engine::traits::Resolver;
...
pub trait Register {
    ...
    /// `resolver` [`resolve()`](tramway_engine::traits::Resolve)
    /// is called.
...
macro_rules! build_register_view {
    ...
    $crate::registers::paste! {
        ...
        impl $crate::registers::register::Register for [< $reg Reg >] {
            fn write(&self, resolver: &impl tramway_engine::traits::Resolver, value: u64) {
            ...
            fn set(&self, resolver: &impl tramway_engine::traits::Resolver, value: u64) {
            ...
            fn reset_sync(&self, resolver: &impl tramway_engine::traits::Resolver) {
