...
//! `TRAMWAY` - Tramway is Rust Async Modelling for hardWare Architecture and
//! sYstems
//!
//! This library provides the core of the [TRAMWAY Engine](crate::engine) which
//! executes event driven asynchronous simulation
//! [components](../tramway_components/index.html).
//!
//! # Developer Guide
//!
//! The Developer Guide provides a document that goes through the TRAMWAY engine
//! and related libraries in a more directed approach than the API guide can.
//! See the `tramway-developer-guide/` folder.
//!
//! # Examples
//!
...
//! clock is the
//! [rate limiter](../tramway_components/flow_controls/rate_limiter/index.html)
