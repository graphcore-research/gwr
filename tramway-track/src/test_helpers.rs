...
/// use tramway_track::test_helpers;
///
/// # /* Need to comment this out so that it is actually built/tested by the infrastructure
/// #[test]
/// # */
/// fn smoke() {
///     let (test_tracker, tracker) = tramway_track::test_init!(10);
///     let top = tramway_track::entity::toplevel(&tracker, "top");
...
/// [test_init](../../tramway_track/macro.test_init.html) must have been called
...
/// # */
/// fn smoke() {
///     let (test_tracker, tracker) = tramway_track::test_init!(20);
///     let top = tramway_track::entity::toplevel(&tracker, "top");
///     let id = tramway_track::create_id!(top);
