...
GWR-based simulations can be run as purely event driven (where one event
...
[clocks]: ../../gwr_engine/time/clocks.md
[engine]: ../../gwr_engine/chapter.md
[`rate_limiter`]: ../../components/gwr_components.md#rate-limiters
