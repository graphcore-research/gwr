...
<!-- cmdrun bash -x -c "cargo doc-gwr --target-dir ../../rustdoc_cache" >> ../../rustdoc_build.log 2>&1 -->
...
<iframe src="../../rustdoc/gwr_engine/index.html" width="100%" height="600" style="border:1px solid black;">
</iframe>
