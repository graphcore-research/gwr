...
pub(super) struct TensorPeConsumption {
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub(super) accesses: Vec<TensorTrafficAccess>,
}

#[derive(Debug, Clone, Serialize, PartialEq, Eq)]
pub(super) struct TensorTrafficAccess {
    #[serde(skip_serializing_if = "Option::is_none")]
    pub(super) layer: Option<String>,
    pub(super) ranges: Vec<TensorTrafficRange>,
}

#[derive(Debug, Clone, Copy, Serialize, PartialEq, Eq)]
pub(super) struct TensorTrafficRange {
    #[serde(serialize_with = "serialize_u64_as_string")]
    pub(super) addr: u64,
    #[serde(serialize_with = "serialize_u64_as_string")]
    pub(super) num_bytes: u64,
