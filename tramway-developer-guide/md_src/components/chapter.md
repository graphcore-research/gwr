...
Simulation components are the basic building blocks of any TRAMWAY model.

The TRAMWAY `Engine` runs components that are connected together using `ports`.

The `tramway_components` library provides a collection of connectable component
