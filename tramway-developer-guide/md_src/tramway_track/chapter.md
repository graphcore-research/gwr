...
`tramway_track` is the logging library used by the TRAMWAY [engine] and all
components. It can be used to generate either text-based or [Cap'n Proto]-based
binary log files.

## Entities

`tramway_track` provides the [`Entity`] struct. It is designed to represent a
...
[`Entity`]: ../tramway_track/chapter.md#entities
[`Id`]: ../tramway_track/chapter.md#ids
