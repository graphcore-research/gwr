...
The default way to build TRAMWAY.
...
The TRAMWAY libraries and APIs are documented using [`rustdoc`]. The
documentation can be built and opened with:
...
But for developers of the TRAMWAY packages use of the nightly toolchain is
required:
...
The TRAMWAY workspace provides an alias that runs `clippy` with additional lint
