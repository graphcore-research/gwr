...
<!-- cmdrun bash -x -c "cargo doc-tramway --target-dir ../../rustdoc_cache" >> ../../rustdoc_build.log 2>&1 -->
...
<iframe src="../../rustdoc/tramway_engine/index.html" width="100%" height="600" style="border:1px solid black;">
</iframe>
...
accessable
<a href="../../rustdoc/tramway_engine/index.html" target="_blank">externally</a>
