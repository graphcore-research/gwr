...
`tramway_engine` is a single-threaded asynchronous simulation engine designed to
run models of asynchronous simulation [components].
...
[clock]: ../tramway_engine/time/clocks.md
[components]: ../components/chapter.md
[`engine`]: ../tramway_engine/chapter.md
[`spawner`]: ../tramway_engine/chapter.md#spawner
