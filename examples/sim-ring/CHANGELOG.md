...
## [7.0.0](https://github.com/graphcore-research/gwr/releases/tag/sim-ring-v7.0.0) - 2025-11-27
...
- add TRAMWAY image
- switch diagrams to text blocks
...
- Add fabric model and tests
- [**breaking**] rebrand as TRAMWAY
- *(steam-track,sim-ring)* add Perfetto tracker MVP
- *(steam-spotter)* add rocket server and d3.js frontend
- *(examples)* add examples/sim-ring as a larger simulation
...
- rename Router to Algorithm to avoid confusion
- rename Tag -> Id. Add traffic generator and improve cache.
- move from panic! to returning Results
- to new_and_register with no local states

### Styling

- set rustfmt `imports_granularity` to `Module`
