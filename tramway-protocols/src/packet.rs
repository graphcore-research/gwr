...
macro_rules! build_packet_type {
    ($protocol:ident, $packet_type:ident, $types:ident, $pkt_type:ident; $($field:ident : $type:ty, $bits:expr, $scale:expr),+ $(,)*) => {
        ...
        impl [< $packet_type  >] {
            ...
            pub fn new(created_by: &std::rc::Rc<tramway_track::entity::Entity>, cfg: &[< $packet_type Cfg >]) -> Self {
                let pkt = Self {
                    ...
                    id: tramway_track::create_id!(created_by),
                ...
                tramway_track::create!(created_by ; pkt, pkt.total_bytes(), pkt.req_type() as i8);
                pkt
            }
        ...
        impl tramway_engine::traits::TotalBytes for [< $packet_type  >] {
        ...
        impl tramway_track::id::Unique for [< $packet_type  >] {
            fn id(&self) -> tramway_track::id::Id {
                self.id
            }
        }

        impl tramway_engine::traits::SimObject for [< $packet_type  >] {}
